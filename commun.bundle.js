...
window.addEventListener('DOMContentLoaded', event => {
  ...
  secretElement.style = "position:fixed; bottom:0;left:0;background-color:transparent;height:3rem;width:3rem";
  secretElement.addEventListener("mousedown", event => {
    time = setTimeout(() => {
  ...
  secretElement.addEventListener("mouseleave", event => {
    clearTimeout(time);
  });
  secretElement.addEventListener("mouseup", event => {
    clearTimeout(time);
  });
  document.querySelector(".content").append(secretElement);
