...
const createSubmitModal = () => {
  ...
  document.getElementById("submited-modal-text").style.display = "block";
  setTimeout(() => {
    document.getElementById("formulaire-submit-button").classList.remove("submited");
    document.getElementById("submited-modal-text").style.display = "none";
  }, 3000);
};
